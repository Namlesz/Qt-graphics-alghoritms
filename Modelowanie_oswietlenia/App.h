...
private:
	...
	void calc_M_matrix();
	void drawSquare(Point2D points[8], bool visible[], double light[]);
	void isVisible(bool visible[], Point3D squarePos[], double light[]);
	void fillWall(Point2D point_1, Point2D point_2, Point2D point_3, Point2D point_4, double light);
