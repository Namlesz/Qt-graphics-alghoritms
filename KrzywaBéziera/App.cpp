...
void App::drawBeziera()
{
	...
	if (points.size() >= 4) {
		...
		while (rozmiar >= 0) {
			...
			for (int i = 0; i < 20; i++) {
				x0 = pow(1 - t, 3) * points[k].x + 3 * pow(1 - t, 2) * t * points[k + 1].x + 3 * (1 - t) * t * t * points[k + 2].x + t * t * t * points[k + 3].x;
				y0 = pow(1 - t, 3) * points[k].y + 3 * pow(1 - t, 2) * t * points[k + 1].y + 3 * (1 - t) * t * t * points[k + 2].y + t * t * t * points[k + 3].y;
				t += 0.05;
				x1 = pow(1 - t, 3) * points[k].x + 3 * pow(1 - t, 2) * t * points[k + 1].x + 3 * (1 - t) * t * t * points[k + 2].x + t * t * t * points[k + 3].x;
				y1 = pow(1 - t, 3) * points[k].y + 3 * pow(1 - t, 2) * t * points[k + 1].y + 3 * (1 - t) * t * t * points[k + 2].y + t * t * t * points[k + 3].y;
